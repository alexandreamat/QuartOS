...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("amount_deserialiser", sa.String(), nullable=False),
        sa.Column("timestamp_deserialiser", sa.String(), nullable=False),
        sa.Column("name_deserialiser", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("default_currency_code", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["replacementpattern_id"],
            ["replacementpattern.id"],
        ),
        sa.ForeignKeyConstraint(
            ["transactiondeserialiser_id"],
            ["transactiondeserialiser.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
